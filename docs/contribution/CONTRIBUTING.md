...
- [CT template: `AppName.sh`](https://github.com/EsBaTix/ProxmoxVED/blob/main/.github/CONTRIBUTOR_AND_GUIDES/ct/AppName.sh)
- [Install template: `AppName-install.sh`](https://github.com/EsBaTix/ProxmoxVED/blob/main/.github/CONTRIBUTOR_AND_GUIDES/install/AppName-install.sh)
...
- [CT coding guide for `AppName.sh`](https://github.com/EsBaTix/ProxmoxVED/blob/main/.github/CONTRIBUTOR_AND_GUIDES/ct/AppName.md)
...
- [Install coding guide for `AppName-install.sh`](https://github.com/EsBaTix/ProxmoxVED/blob/main/.github/CONTRIBUTOR_AND_GUIDES/install/AppName-install.md)
