...
# upstream   https://github.com/EsBaTix/ProxmoxVED.git (fetch)
# upstream   https://github.com/EsBaTix/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/EsBaTix/ProxmoxVED"
echo ""
