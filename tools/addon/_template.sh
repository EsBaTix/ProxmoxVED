...
source <(curl -fsSL https://raw.githubusercontent.com/EsBaTix/ProxmoxVED/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/EsBaTix/ProxmoxVED/main/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/EsBaTix/ProxmoxVED/main/misc/tools.func) 2>/dev/null || {
