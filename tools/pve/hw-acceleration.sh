...
# Repo: https://github.com/EsBaTix/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/EsBaTix/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/EsBaTix/ProxmoxVED
...
source <(wget -qO- https://github.com/EsBaTix/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/EsBaTix/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/EsBaTix/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
