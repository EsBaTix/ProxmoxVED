...
# License: MIT | https://github.com/EsBaTix/ProxmoxVED/raw/main/LICENSE
...
<div align='center'>
  ...
  <span style='margin: 0 10px;'>
    ...
    <a href='https://github.com/EsBaTix/ProxmoxVED/discussions' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Discussions</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-exclamation-circle fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/EsBaTix/ProxmoxVED/issues' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Issues</a>
  </span>
</div>
EOF
)
...
echo "More Info at https://github.com/EsBaTix/ProxmoxVED/discussions/836"
